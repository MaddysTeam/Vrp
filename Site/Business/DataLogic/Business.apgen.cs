...
namespace Res.Business {
            ...
            public virtual StringAPColumnDef ExtName {
                get {
                    if (Object.ReferenceEquals(_extName, null)) {
                        _extName = new StringAPColumnDef(this, "ExtName", false, 10);
    ...
    public partial class APDalDef {
        ...
        public partial class MicroCourseDalBase : APDal {
            ...
            public virtual void Update(MicroCourse data) {
                var query = APQuery.update(APDBDef.MicroCourse).values(APDBDef.MicroCourse.ResourceId.SetValue(data.ResourceId), APDBDef.MicroCourse.VideoId.SetValue(data.VideoId), APDBDef.MicroCourse.CoverId.SetValue(data.CoverId), APDBDef.MicroCourse.DesignId.SetValue(data.DesignId), APDBDef.MicroCourse.SummaryId.SetValue(data.SummaryId), APDBDef.MicroCourse.CharpterSortId.SetValue(data.CharpterSortId)).where((APDBDef.MicroCourse.CourseId == data.CourseId));
                ExecuteNonQuery(query);
            }
        ...
        public partial class ExercisesDalBase : APDal {
            ...
            public virtual void Insert(Exercises data) {
                ...
                var query = APQuery.insert(APDBDef.Exercises).values(APDBDef.Exercises.ExerciseId.SetValue(data.ExerciseId), APDBDef.Exercises.CourseId.SetValue(data.CourseId), APDBDef.Exercises.Title.SetValue(data.Title), APDBDef.Exercises.Answer.SetValue(data.Answer));
                ExecuteNonQuery(query);
            }
            ...
            public virtual void Update(Exercises data) {
                var query = APQuery.update(APDBDef.Exercises).values(APDBDef.Exercises.CourseId.SetValue(data.CourseId), APDBDef.Exercises.Title.SetValue(data.Title), APDBDef.Exercises.Answer.SetValue(data.Answer)).where((APDBDef.Exercises.ExerciseId == data.ExerciseId));
                ExecuteNonQuery(query);
            }
    ...
    public abstract partial class MicroCourseBase {
        ...
        /// 初始化所有字段的构造函数。
        /// </summary>
        public MicroCourseBase(long courseId, long resourceId, long videoId, long coverId, long designId, long summaryId, long charpterSortId) {
            _courseId = courseId;
            _resourceId = resourceId;
            _videoId = videoId;
            _coverId = coverId;
    ...
    public partial class MicroCourse : MicroCourseBase {
        ...
        /// 初始化所有字段的构造函数。
        /// </summary>
        public MicroCourse(long courseId, long resourceId, long videoId, long coverId, long designId, long summaryId, long charpterSortId) : 
                base(courseId, resourceId, videoId, coverId, designId, summaryId, charpterSortId) {
        }
    }
    ...
    public abstract partial class ExercisesBase {
        ...
        /// 初始化所有字段的构造函数。
        /// </summary>
        public ExercisesBase(long exerciseId, long courseId, string title, string answer) {
        ...
        public static StringAPColumnDef TitleDef {
            get {
                return APDBDef.Exercises.Title;
            }
        }
    ...
    public partial class Exercises : ExercisesBase {
        ...
        /// 初始化所有字段的构造函数。
        /// </summary>
        public Exercises(long exerciseId, long courseId, string title, string answer) : 
                base(exerciseId, courseId, title, answer) {
        }
    }
