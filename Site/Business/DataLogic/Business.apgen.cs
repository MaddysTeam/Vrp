...
namespace Res.Business {
    ...
    public partial class APDBDef : APDatabase {
        ...
        public partial class CroResourceTableDef : APTableDef {
            ...
            public virtual void Fullup(IDataReader reader, CroResource data, bool throwIfValidColumnName) {
                ...
                data.PublicStatePKID = PublicStatePKID.GetValue<long>(reader, throwIfValidColumnName, 0);
                data.DownloadStatePKID = DownloadStatePKID.GetValue<long>(reader, throwIfValidColumnName, 0);
    ...
    public partial class ResUser : ResUserBase {
        ...
        public ResUser(
                    ...
                    int loginCount, 
                    string mD5) : 
                base(userId, userName, password, passwordHash, securityStamp, question, answer, userTypePKID, realName, photoPath, genderPKID, iDCard, email, companyId, actived, removed, registerTime, lastLoginTime, loginCount, mD5) {
        }
    }
    ...
    public abstract partial class ActiveBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public ActiveBase(long activeId, string activeName, string description, string company, long levelPKID, System.DateTime startDate, System.DateTime endDate, System.DateTime uploadStartDate, System.DateTime uploadEndDate, bool isCurrent) {
            _activeId = activeId;
    ...
    public partial class Active : ActiveBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public Active(long activeId, string activeName, string description, string company, long levelPKID, System.DateTime startDate, System.DateTime endDate, System.DateTime uploadStartDate, System.DateTime uploadEndDate, bool isCurrent) : 
                base(activeId, activeName, description, company, levelPKID, startDate, endDate, uploadStartDate, uploadEndDate, isCurrent) {
        }
    }
    ...
    public abstract partial class CroResourceBase {
        ...
        /// </summary>
        private long _publicStatePKID = 0;
        
        /// <summary>
        /// PickList - APEdu.net key is PLKey_ResourceDownloadState
        /// </summary>
        private long _downloadStatePKID = 0;
    ...
    public abstract partial class MicroCourseBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public MicroCourseBase(long courseId, string courseTitle, long resourceId, long videoId, long coverId, long designId, long summaryId, long coursewareId, long attachmentId, long charpterSortId, int playCount) {
            _courseId = courseId;
    ...
    public partial class MicroCourse : MicroCourseBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public MicroCourse(long courseId, string courseTitle, long resourceId, long videoId, long coverId, long designId, long summaryId, long coursewareId, long attachmentId, long charpterSortId, int playCount) : 
                base(courseId, courseTitle, resourceId, videoId, coverId, designId, summaryId, coursewareId, attachmentId, charpterSortId, playCount) {
        }
    }
