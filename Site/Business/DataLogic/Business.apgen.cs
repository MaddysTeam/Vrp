...
namespace Res.Business {
            ...
            public virtual StringAPColumnDef ActiveName {
                get {
                    if (Object.ReferenceEquals(_activeName, null)) {
                        _activeName = new StringAPColumnDef(this, "ActiveName", false, 255);
            ...
            public virtual StringAPColumnDef Company {
                get {
                    if (Object.ReferenceEquals(_company, null)) {
                        _company = new StringAPColumnDef(this, "Company", false, 255);
    ...
    public partial class APDalDef {
        ...
        public partial class ActiveDalBase : APDal {
            ...
            public virtual void Update(Active data) {
                var query = APQuery.update(APDBDef.Active).values(APDBDef.Active.ActiveName.SetValue(data.ActiveName), APDBDef.Active.Description.SetValue(data.Description), APDBDef.Active.Company.SetValue(data.Company), APDBDef.Active.LevelPKID.SetValue(data.LevelPKID), APDBDef.Active.StartDate.SetValue(data.StartDate), APDBDef.Active.EndDate.SetValue(data.EndDate), APDBDef.Active.UploadStartDate.SetValue(data.UploadStartDate), APDBDef.Active.UploadEndDate.SetValue(data.UploadEndDate)).where((APDBDef.Active.ActiveId == data.ActiveId));
                ExecuteNonQuery(query);
            }
        ...
        public partial class EvalGroupDalBase : APDal {
            ...
            public virtual void Update(EvalGroup data) {
                var query = APQuery.update(APDBDef.EvalGroup).values(APDBDef.EvalGroup.GroupName.SetValue(data.GroupName), APDBDef.EvalGroup.LevelPKID.SetValue(data.LevelPKID), APDBDef.EvalGroup.StartDate.SetValue(data.StartDate), APDBDef.EvalGroup.EndDate.SetValue(data.EndDate), APDBDef.EvalGroup.ActiveId.SetValue(data.ActiveId)).where((APDBDef.EvalGroup.GroupId == data.GroupId));
                ExecuteNonQuery(query);
            }
        ...
        public partial class EvalResultDalBase : APDal {
            ...
            public virtual void Update(EvalResult data) {
                var query = APQuery.update(APDBDef.EvalResult).values(APDBDef.EvalResult.ExpertId.SetValue(data.ExpertId), APDBDef.EvalResult.GroupId.SetValue(data.GroupId), APDBDef.EvalResult.ResourceId.SetValue(data.ResourceId), APDBDef.EvalResult.AccessDate.SetValue(data.AccessDate), APDBDef.EvalResult.Score.SetValue(data.Score)).where((APDBDef.EvalResult.ResultId == data.ResultId));
                ExecuteNonQuery(query);
            }
    ...
    public abstract partial class ActiveBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public ActiveBase(long activeId, string activeName, string description, string company, long levelPKID, System.DateTime startDate, System.DateTime endDate, System.DateTime uploadStartDate, System.DateTime uploadEndDate) {
            _activeId = activeId;
    ...
    public partial class Active : ActiveBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public Active(long activeId, string activeName, string description, string company, long levelPKID, System.DateTime startDate, System.DateTime endDate, System.DateTime uploadStartDate, System.DateTime uploadEndDate) : 
                base(activeId, activeName, description, company, levelPKID, startDate, endDate, uploadStartDate, uploadEndDate) {
        }
    }
    ...
    public partial class CroResource : CroResourceBase {
        ...
        public CroResource(
                    ...
                    long lastModifier, 
                    System.DateTime lastModifiedTime) : 
                base(crosourceId, title, author, keywords, description, provinceId, areaId, companyId, authorCompany, authorAddress, authorEmail, authorPhone, stagePKID, gradePKID, resourceTypePKID, subjectPKID, courseTypePKID, statePKID, downCount, favoriteCount, viewCount, commentCount, eliteScore, auditor, auditedTime, auditOpinion, creator, createdTime, lastModifier, lastModifiedTime) {
        }
    }
    ...
    public abstract partial class EvalGroupBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public EvalGroupBase(long groupId, string groupName, long levelPKID, System.DateTime startDate, System.DateTime endDate, long activeId) {
            _groupId = groupId;
    ...
    public partial class EvalGroup : EvalGroupBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public EvalGroup(long groupId, string groupName, long levelPKID, System.DateTime startDate, System.DateTime endDate, long activeId) : 
                base(groupId, groupName, levelPKID, startDate, endDate, activeId) {
        }
    }
    ...
    public abstract partial class EvalResultBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public EvalResultBase(long resultId, long expertId, long groupId, long resourceId, System.DateTime accessDate, double score) {
            _resultId = resultId;
            _expertId = expertId;
            _groupId = groupId;
            _resourceId = resourceId;
    ...
    public partial class EvalResult : EvalResultBase {
        ...
        /// Constructor with all field values.
        /// </summary>
        public EvalResult(long resultId, long expertId, long groupId, long resourceId, System.DateTime accessDate, double score) : 
                base(resultId, expertId, groupId, resourceId, accessDate, score) {
        }
    }
