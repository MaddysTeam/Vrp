...
namespace Res.Business {
    ...
    public abstract partial class IndicationBase {
        ...
        /// 初始化所有字段的构造函数。
        /// </summary>
        public IndicationBase(long indicationId, string indicationName, string description, long typePKID, int level, int status) {
    ...
    public partial class Indication : IndicationBase {
        ...
        /// 初始化所有字段的构造函数。
        /// </summary>
        public Indication(long indicationId, string indicationName, string description, long typePKID, int level, int status) : 
                base(indicationId, indicationName, description, typePKID, level, status) {
        }
    }
