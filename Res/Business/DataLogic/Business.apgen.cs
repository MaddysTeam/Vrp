...
namespace Res.Business {
    ...
    public partial class APDBDef : APDatabase {
        ...
        public partial class CroResourceTableDef : APTableDef {
            ...
            private StringAPColumnDef _rType;
            
            private StringAPColumnDef _rSource;
            ...
            /// RType ColumnDef
            /// </summary>
            public virtual StringAPColumnDef RType {
                get {
                    if (Object.ReferenceEquals(_rType, null)) {
                        _rType = new StringAPColumnDef(this, "RType", false, 20);
                        _rType.Display = "资源类型";
                    }
                    return _rType;
                }
            ...
            /// RSource ColumnDef
            /// </summary>
            public virtual StringAPColumnDef RSource {
                get {
                    if (Object.ReferenceEquals(_rSource, null)) {
                        _rSource = new StringAPColumnDef(this, "RSource", false, 500);
                        _rSource.Display = "资源出处";
                    }
                    return _rSource;
                }
            }
            ...
            public virtual void Fullup(IDataReader reader, CroResource data, bool throwIfValidColumnName) {
                ...
                data.RType = RType.GetValue<string>(reader, throwIfValidColumnName);
                data.RSource = RSource.GetValue<string>(reader, throwIfValidColumnName);
                data.Title = Title.GetValue<string>(reader, throwIfValidColumnName);
                data.Author = Author.GetValue<string>(reader, throwIfValidColumnName);
                data.Keywords = Keywords.GetValue<string>(reader, throwIfValidColumnName);
                data.Description = Description.GetValue<string>(reader, throwIfValidColumnName);
    ...
    public partial class APDalDef {
        ...
        public partial class CroResourceDalBase : APDal {
            ...
            public virtual void Insert(CroResource data) {
                ...
                var query = APQuery.insert(APDBDef.CroResource).values(APDBDef.CroResource.CrosourceId.SetValue(data.CrosourceId), APDBDef.CroResource.RType.SetValue(data.RType), APDBDef.CroResource.RSource.SetValue(data.RSource), APDBDef.CroResource.Title.SetValue(data.Title), APDBDef.CroResource.Author.SetValue(data.Author), APDBDef.CroResource.Keywords.SetValue(data.Keywords), APDBDef.CroResource.Description.SetValue(data.Description), APDBDef.CroResource.CoverPath.SetValue(data.CoverPath), APDBDef.CroResource.ResourcePath.SetValue(data.ResourcePath), APDBDef.CroResource.FileExtName.SetValue(data.FileExtName), APDBDef.CroResource.FileSize.SetValue(data.FileSize), APDBDef.CroResource.IsLink.SetValue(data.IsLink), APDBDef.CroResource.AuthorCompany.SetValue(data.AuthorCompany), APDBDef.CroResource.AuthorAddress.SetValue(data.AuthorAddress), APDBDef.CroResource.AuthorEmail.SetValue(data.AuthorEmail), APDBDef.CroResource.AuthorPhone.SetValue(data.AuthorPhone), APDBDef.CroResource.DeformityPKID.SetValue(data.DeformityPKID), APDBDef.CroResource.DomainPKID.SetValue(data.DomainPKID), APDBDef.CroResource.LearnFromPKID.SetValue(data.LearnFromPKID), APDBDef.CroResource.SchoolTypePKID.SetValue(data.SchoolTypePKID), APDBDef.CroResource.StagePKID.SetValue(data.StagePKID), APDBDef.CroResource.GradePKID.SetValue(data.GradePKID), APDBDef.CroResource.ImportSourcePKID.SetValue(data.ImportSourcePKID), APDBDef.CroResource.MediumTypePKID.SetValue(data.MediumTypePKID), APDBDef.CroResource.ResourceTypePKID.SetValue(data.ResourceTypePKID), APDBDef.CroResource.SubjectPKID.SetValue(data.SubjectPKID), APDBDef.CroResource.DownCount.SetValue(data.DownCount), APDBDef.CroResource.FavoriteCount.SetValue(data.FavoriteCount), APDBDef.CroResource.ViewCount.SetValue(data.ViewCount), APDBDef.CroResource.CommentCount.SetValue(data.CommentCount), APDBDef.CroResource.StarCount.SetValue(data.StarCount), APDBDef.CroResource.StarTotal.SetValue(data.StarTotal), APDBDef.CroResource.EliteScore.SetValue(data.EliteScore), APDBDef.CroResource.StatePKID.SetValue(data.StatePKID), APDBDef.CroResource.Auditor.SetValue(data.Auditor), APDBDef.CroResource.AuditedTime.SetValue(data.AuditedTime), APDBDef.CroResource.AuditOpinion.SetValue(data.AuditOpinion), APDBDef.CroResource.Creator.SetValue(data.Creator), APDBDef.CroResource.CreatedTime.SetValue(data.CreatedTime), APDBDef.CroResource.LastModifier.SetValue(data.LastModifier), APDBDef.CroResource.LastModifiedTime.SetValue(data.LastModifiedTime));
                ExecuteNonQuery(query);
            }
            ...
            public virtual void Update(CroResource data) {
                var query = APQuery.update(APDBDef.CroResource).values(APDBDef.CroResource.RType.SetValue(data.RType), APDBDef.CroResource.RSource.SetValue(data.RSource), APDBDef.CroResource.Title.SetValue(data.Title), APDBDef.CroResource.Author.SetValue(data.Author), APDBDef.CroResource.Keywords.SetValue(data.Keywords), APDBDef.CroResource.Description.SetValue(data.Description), APDBDef.CroResource.CoverPath.SetValue(data.CoverPath), APDBDef.CroResource.ResourcePath.SetValue(data.ResourcePath), APDBDef.CroResource.FileExtName.SetValue(data.FileExtName), APDBDef.CroResource.FileSize.SetValue(data.FileSize), APDBDef.CroResource.IsLink.SetValue(data.IsLink), APDBDef.CroResource.AuthorCompany.SetValue(data.AuthorCompany), APDBDef.CroResource.AuthorAddress.SetValue(data.AuthorAddress), APDBDef.CroResource.AuthorEmail.SetValue(data.AuthorEmail), APDBDef.CroResource.AuthorPhone.SetValue(data.AuthorPhone), APDBDef.CroResource.DeformityPKID.SetValue(data.DeformityPKID), APDBDef.CroResource.DomainPKID.SetValue(data.DomainPKID), APDBDef.CroResource.LearnFromPKID.SetValue(data.LearnFromPKID), APDBDef.CroResource.SchoolTypePKID.SetValue(data.SchoolTypePKID), APDBDef.CroResource.StagePKID.SetValue(data.StagePKID), APDBDef.CroResource.GradePKID.SetValue(data.GradePKID), APDBDef.CroResource.ImportSourcePKID.SetValue(data.ImportSourcePKID), APDBDef.CroResource.MediumTypePKID.SetValue(data.MediumTypePKID), APDBDef.CroResource.ResourceTypePKID.SetValue(data.ResourceTypePKID), APDBDef.CroResource.SubjectPKID.SetValue(data.SubjectPKID), APDBDef.CroResource.DownCount.SetValue(data.DownCount), APDBDef.CroResource.FavoriteCount.SetValue(data.FavoriteCount), APDBDef.CroResource.ViewCount.SetValue(data.ViewCount), APDBDef.CroResource.CommentCount.SetValue(data.CommentCount), APDBDef.CroResource.StarCount.SetValue(data.StarCount), APDBDef.CroResource.StarTotal.SetValue(data.StarTotal), APDBDef.CroResource.EliteScore.SetValue(data.EliteScore), APDBDef.CroResource.StatePKID.SetValue(data.StatePKID), APDBDef.CroResource.Auditor.SetValue(data.Auditor), APDBDef.CroResource.AuditedTime.SetValue(data.AuditedTime), APDBDef.CroResource.AuditOpinion.SetValue(data.AuditOpinion), APDBDef.CroResource.Creator.SetValue(data.Creator), APDBDef.CroResource.CreatedTime.SetValue(data.CreatedTime), APDBDef.CroResource.LastModifier.SetValue(data.LastModifier), APDBDef.CroResource.LastModifiedTime.SetValue(data.LastModifiedTime)).where((APDBDef.CroResource.CrosourceId == data.CrosourceId));
                ExecuteNonQuery(query);
            }
    ...
    public abstract partial class CroResourceBase {
        ...
        /// RSource
        /// </summary>
        private string _rSource = string.Empty;
        ...
        /// RType APColumnDef
        /// </summary>
        public static StringAPColumnDef RTypeDef {
            get {
                return APDBDef.CroResource.RType;
            }
        }
        ...
        /// RSource APColumnDef
        /// </summary>
        public static StringAPColumnDef RSourceDef {
            get {
                return APDBDef.CroResource.RSource;
            }
        }
        ...
        public static BooleanAPColumnDef IsLinkDef {
            get {
                return APDBDef.CroResource.IsLink;
            }
        }
        ...
        public static Int64APColumnDef DeformityPKIDDef {
            get {
                return APDBDef.CroResource.DeformityPKID;
            }
        }
        ...
        public static Int64APColumnDef DomainPKIDDef {
            get {
                return APDBDef.CroResource.DomainPKID;
            }
        }
        ...
        public static Int64APColumnDef LearnFromPKIDDef {
            get {
                return APDBDef.CroResource.LearnFromPKID;
            }
        }
        ...
        public static Int64APColumnDef SchoolTypePKIDDef {
            get {
                return APDBDef.CroResource.SchoolTypePKID;
            }
        }
        ...
        public static Int32APColumnDef StarCountDef {
            get {
                return APDBDef.CroResource.StarCount;
            }
        }
        ...
        public static Int32APColumnDef StarTotalDef {
            get {
                return APDBDef.CroResource.StarTotal;
            }
        }
    ...
    public partial class CroResource : CroResourceBase {
        ...
        public CroResource(
                    ...
                    long lastModifier, 
                    System.DateTime lastModifiedTime) : 
                base(crosourceId, rType, rSource, title, author, keywords, description, coverPath, resourcePath, fileExtName, fileSize, isLink, authorCompany, authorAddress, authorEmail, authorPhone, deformityPKID, domainPKID, learnFromPKID, schoolTypePKID, stagePKID, gradePKID, importSourcePKID, mediumTypePKID, resourceTypePKID, subjectPKID, downCount, favoriteCount, viewCount, commentCount, starCount, starTotal, eliteScore, statePKID, auditor, auditedTime, auditOpinion, creator, createdTime, lastModifier, lastModifiedTime) {
        }
    }
