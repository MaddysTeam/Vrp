...
(function (factory) {
  ...
  var EventHandler = function () {
     ...
     */
	 // change by leocaan
    this.attach = function (layoutInfo, options, $target) {
      ...
      if (options.onenter) {
		...
		// change by leocaan
      if (options.onfocus) { layoutInfo.editable.on('focus', $target, options.onfocus); }
      if (options.onblur) { layoutInfo.editable.on('blur', $target, options.onblur); }
      if (options.onkeyup) { layoutInfo.editable.on('keyup', $target, options.onkeyup); }
      if (options.onkeydown) { layoutInfo.editable.on('keydown', $target, options.onkeydown); }
      if (options.onpaste) { layoutInfo.editable.on('paste', $target, options.onpaste); }
  ...
  $.fn.extend({
    ...
    summernote: function (options) {
      ...
      this.each(function (idx, holder) {
        ...
        // change by leocaan
        eventHandler.attach(info, options, this);
